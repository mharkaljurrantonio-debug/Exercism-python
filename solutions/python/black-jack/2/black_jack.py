...
def is_blackjack(card_one, card_two):
    ...
    if card_one == "A" and card_two == "J":
        return True
    if card_two == "A" and card_one == "J":
        return True
    if card_one == "A" and card_two == "K":
        return True 
    if card_two == "A" and card_one == "K":
        return True
    if card_one == "A" and card_two == "Q":
        return True
    if card_two == "A" and card_one == "Q":
        return True
    if card_one == "A" and card_two == "10":
        return True
    if card_two == "A" and card_one == "10":
        return True
    return False
...
def can_double_down(card_one, card_two):
    ...
    val1 = value_of_card(card_one)
    val2 = value_of_card(card_two)
    if val1 + val2 == 9 or val1 + val2 == 10 or val1 + val2 == 11:
        return True
    return False
